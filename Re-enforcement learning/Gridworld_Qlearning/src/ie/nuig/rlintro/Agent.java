 ...
 * Dr. Patrick Mannion, National University of Ireland Galway, March 2020
 * Slide numbers reference the lecture notes file "Introduction to Reinforcement Learning slides.pdf"
 */
...
public class Agent {
	...
	private float[][] qTable; // Slide #19, tabular q value store, [stateNumber, actionNumber]	

	// agent parameters, default values
	private float alpha = 0.1f; // Slide #37, learning rate
	private float gamma = 0.9f; // Slide #20, discount factor
	private float epsilon = 0.1f; // Slide #20, exploration rate
	...
	public void updateQValue(int previousState, int selectedAction, int currentState, float reward) {
		// implementation of Q-learning TD update rule (see slides #20, #29)
	...
	public int selectAction(int state) {
		// epsilon-greedy action selection strategy implementation (see slide #21)
